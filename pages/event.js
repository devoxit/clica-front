            ...
            <div className="row gx-lg-9">
              <div className="col-xl-8 border-end-xl border-300">
                  ...
                  <div className="card-body">
                      ...
                      <div className="card-body">
                        <div className="row gy-5">
                            ...
                            <div>
                              <div className="mb-3">
                                <div className="d-flex align-items-center">
                                  <div className="px-2 py-1 bg-info-100 rounded"><span className="text-info" data-feather="map-pin"></span></div>
                          ...
                          <div className="col-md-6">
                            <div className="mb-3">
                              <div className="d-flex align-items-center">
                                <div className="px-2 py-1 bg-primary-100 rounded"><span className="text-primary" data-feather="clock"></span></div>
                    ...
                    <div className="row g-2">
                      <div className="col-12 col-md-auto flex-md-grow-1">
                        <button className="btn btn-primary w-100" type="button">Get Tickets</button>
                      </div>
                      <div className="col-12 col-sm-auto flex-sm-grow-1 flex-md-grow-0">
                        <button className="btn btn-phoenix-primary w-100" type="button"><span className="fa-regular fa-calendar-plus me-2"></span>Add to Calendar </button>
                      </div>
                      <div className="col-6 col-sm-auto">
                        <button className="btn btn-phoenix-primary w-100" type="button"><span className="fa-solid fa-heart me-2"></span>3677</button>
                      </div>
                      <div className="col-6 col-sm-auto">
                        <button className="btn btn-phoenix-primary w-100" type="button"><span className="fa-solid fa-share-nodes me-2"></span>4467</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="row g-1 g-sm-2 mb-7 mb-xxl-8">
                  ...
                  <div className="col-6"><a href="../../assets/img/gallery/21.jpg" data-gallery="gallery-posts-undefined"><img className="rounded h-100 w-100 fit-cover" src="../../assets/img/gallery/21.jpg" alt="..." /></a></div>
                </div>
                <h4 className="mb-3 text-1000 fs-xxl-2">Topic To Be Covered:</h4>
                ...
                <div className="d-flex mb-5">
                  <button className="btn btn-phoenix-primary btn-icon me-2"><span className="fa-brands fa-facebook text-facebbok"></span></button>
                  <button className="btn btn-phoenix-primary btn-icon me-2"><span className="fa-brands fa-facebook-messenger"></span></button>
                  <button className="btn btn-phoenix-primary btn-icon me-2"><span className="fa-brands fa-twitter text-info"></span></button>
                  <button className="btn btn-phoenix-primary btn-icon me-2"><span className="fa-solid fa-envelope text-danger"></span></button>
                  <button className="btn btn-phoenix-primary btn-icon me-2"><span className="fa-brands fa-linkedin-in text-info"></span></button>
                </div>
                <button className="btn btn-phoenix-primary w-100 mb-5 mb-xl-0" type="button">Load more</button>
              </div>
              <div className="col-xl-4">
                ...
                <div className="row g-2 mb-6 align-items-center">
                  ...
                  <div className="col-sm-auto">
                    <button className="btn btn-phoenix-primary px-3" type="button"><span className="fa-solid fa-user-plus me-2"></span>Follow</button>
                  </div>
                </div>
                <div className="mb-8">
                  ...
                  <div className="row flex-between-center g-0 gy-3">
                    <div className="col-12 col-sm-auto me-1">
                      <div className="d-flex">
                        <h3 className="fw-bold text-1000 fs-0 me-2 mb-0">James Tiberius Auditorium</h3>
                        <p className="mb-0 text-1000 fs--1">Vancouver</p>
                      </div>
                    </div>
                    <div className="col-12 col-sm-auto col-xl-12">
                      <button className="btn btn-phoenix-primary w-100" type="button"><span className="fa-solid fa-route me-2"></span>Get directions</button>
                    </div>
                  </div>
                </div>
                <h3 className="mb-3">Tags</h3>
                <div className="d-flex flex-wrap pb-7 border-bottom"><span className="badge badge-tag me-2 mb-2">Music</span><span className="badge badge-tag me-2 mb-2">CONCERT</span><span className="badge badge-tag mb-2">Greatest show on earth</span></div>
                <div className="row g-0 py-3 border-bottom border-dashed border-300 align-items-end justify-content-between">
                  ...
                  <div className="col-auto"><a className="fw-bold text-decoration-none fs--1" href="#!">See more</a></div>
                </div>
                <div className="py-3 border-bottom border-dashed">
                  ...
                  </div><a className="hover-primary text-decoration-none text-1000 fw-bold mb-2 line-clamp-1 me-5 lh-base" href="#!">Master Class on FILM Studies THESIS on Makers</a>
                ...
                <div className="py-3 border-bottom border-dashed">
                  ...
                  </div><a className="hover-primary text-decoration-none text-1000 fw-bold mb-2 line-clamp-1 me-5 lh-base" href="#!">Witnessing History in Making Photographs</a>
                  <p className="text-800 fs--1 mb-2">Organized by <br /><a className="fw-bold text-primary" href="#!">IAFM- International Academy of Film and Media</a></p>
                  <p className="fs--2 text-600">64 people going</p>
                  <p className="fs--1 text-700 fw-bold mb-1"><span className="fa-solid fa-clock text-800 me-1"></span>12.30PM - 10PM</p>
                  <p className="fs--1 text-700 fw-bold mb-0"><span className="fa-solid fa-map-marker-alt text-800 me-1"></span>Tavern on the Greend&lsquo; New York</p>
          ...
          <footer className="footer position-absolute">
            <div className="row g-0 justify-content-between align-items-center h-100">
              <div className="col-12 col-sm-auto text-center">
                <p className="mb-0 mt-2 mt-sm-0 text-900">Thank you for creating with Phoenix<span className="d-none d-sm-inline-block"></span><span className="d-none d-sm-inline-block mx-1">|</span><br className="d-sm-none" />2023 &copy;<a className="mx-1" href="https://themewagon.com">Themewagon</a></p>
              </div>
              <div className="col-12 col-sm-auto text-center">
