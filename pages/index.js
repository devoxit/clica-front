  ...
  return (
    ...
    <link href="assets/css/user.min.css" type="text/css" rel="stylesheet" id="user-style-default" />
        ...
        <div class="container-small px-0 px-sm-3"><a class="navbar-brand flex-1 flex-lg-grow-0" href="index.html">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-grid d-lg-flex align-items-center">
              ...
              </div><a class="text-500 px-2 d-none d-lg-inline me-2" href="#" data-bs-toggle="modal" data-bs-target="#searchBoxModal"><span data-feather="search" style={{height:"12px",width:"12px"}}></span></a><a class="btn btn-link text-900 order-1 order-lg-0 ps-3 me-2" href="pages/authentication/simple/sign-in.html">Sign in</a><a class="btn btn-phoenix-primary order-0" href="pages/authentication/simple/sign-up.html"><span class="fw-bold">Sign Up</span></a>
            </div>
          </div>
        </div>
      </nav>
      <div class="modal fade" id="searchBoxModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="true" data-phoenix-modal="data-phoenix-modal" style={{--phoenixBackdropOpacity: "1"}}>
          ...
          <div class="row align-items-center">
            <div class="col-12 col-lg-auto order-0 order-md-1 text-end order-1">
              <div class="position-relative p-5 p-md-7 d-lg-none">
                <div class="bg-holder" style={{backgroundImage:"url(assets/img/bg/bg-23.png)",backgroundSize:"contain"}}>
                </div>
      ...
      <div class="position-relative">
        <div class="bg-holder z-index-2 d-none d-md-block" style={{backgroundImage:"url(assets/img/bg/13.png)",backgroundSize:"auto",backgroundPosition:"right"}}>
        </div>
        

        <div class="bg-holder z-index-2 d-none d-md-block d-lg-none d-xl-block" style={{backgroundImage:"url(assets/img/bg/bg-12.png)",backgroundSize:"auto",backgroundPosition:"left"}}>
        </div>
                  ...
                  <div class="carousel-inner">
                      ...
                      <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                        <div class="col-lg-6 col-xl-5 text-center">
                          <div class="testimonial-avatar-container d-inline-block position-relative">
                            <div class="bg-holder" style={{backgroundImage:"url(assets/img/bg/bg-2.png)",backgroundSize:"contain"}}>
                            </div>
                    ...
                    <div class="carousel-item">
                      <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                        <div class="col-lg-6 col-xl-5 text-center">
                          <div class="testimonial-avatar-container d-inline-block position-relative">
                            <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-2.png);background-size:contain;">
                            </div>
      ...
      <div class="position-relative">
        <div class="bg-holder world-map-bg" style="backgroundImage:url(assets/img/bg/bg-13.png);">
        </div>
        

        <div class="bg-holder z-index-2 opacity-25" style="backgroundImage:url(assets/img/bg/bg-right-21.png);background-size:auto;background-position:right;">
        </div>
        

        <div class="bg-holder z-index-2 mt-9 opacity-25" style="backgroundImage:url(assets/img/bg/bg-left-21.png);background-size:auto;background-position:left;">
        </div>
      ...
      <section class="bg-white">
        <div class="bg-holder d-dark-none" style="backgroundImage:url(assets/img/bg/bg-5.png);background-size:auto;">
        </div>
        

        <div class="bg-holder d-light-none" style="backgroundImage:url(assets/img/bg/bg-dark-5.png);background-size:auto;">
        </div>
        

        <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-left-5.png);background-position:left;background-size:auto;">
        </div>
        

        <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-right-6.png);background-position:right;background-size:auto;">
        </div>
      ...
      <section class="bg-white">
        <div class="bg-holder d-none d-md-block" style="backgroundImage:url(assets/img/bg/bg-left-15.png);background-position:left;background-size:auto;">
        </div>
        

        <div class="bg-holder d-none d-md-block" style="backgroundImage:url(assets/img/bg/bg-right-15.png);background-position:right;background-size:auto;">
        </div>
      ...
      <section id="team">
        <div class="bg-holder z-index-2" style="backgroundImage:url(assets/img/bg/bg-left-17.png);background-size:auto;background-position:left center;">
        </div>
        

        <div class="bg-holder z-index-2" style="backgroundImage:url(assets/img/bg/bg-right-17.png);background-size:auto;background-position:right center;">
        </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="text-center mt-5 position-relative">
                <div class="team-avatar-container d-inline-block position-relative">
                  <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-21.png);background-size:contain;">
                  </div>
          ...
          <div class="row justify-content-center">
            <div class="col-12 text-center">
              <div class="card py-md-9 px-md-13 border-0 z-index-1 shadow-lg cta-card">
                <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-18.png);background-position:right;background-size:auto;">
                </div>
      ...
      <div class="position-relative">
        <div class="bg-holder footer-bg" style="backgroundImage:url(assets/img/bg/bg-19.png);background-size:auto;">
        </div>
        

        <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-right-20.png);background-position:right;background-size:auto;">
        </div>
        

        <div class="bg-holder" style="backgroundImage:url(assets/img/bg/bg-left-20.png);background-position:left;background-size:auto;">
        </div>
